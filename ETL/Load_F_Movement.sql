INSERT INTO F_MOVEMENT(delta_altitude, delta_time, grid_id, start_time_id, date_id, 
surface_temperature_id, dew_point_temperature_id, wind_speed_id, wind_direction_id, 
pressure_id, visibility_id, VISIBILITY_TYPE_ID, cloud_coverage_id, cloud_altitude_id)
  SELECT jwd.delta_altitude, jwd.delta_time, grid_cell_id, t.TIME_ID, d.DATE_ID, st.SURFACE_TEMPERATURE_ID, dp.DEW_POINT_TEMPERATURE_ID,
          ws.WIND_SPEED_ID, wd.WIND_DIRECTION_ID, p.PRESSURE_ID, v.VISIBILITY_ID, 'NULL', clc.CLOUD_COVERAGE_ID, ca.CLOUD_ALTITUDE_ID
  FROM TRANSFORM_IGC_7_JOIN_WEATHER_DATA jwd
