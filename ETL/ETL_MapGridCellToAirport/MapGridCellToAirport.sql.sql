...
/* First the center of latitude and longitude is calculated for each grid cell
...
select a.grid_cell_id, b.initials, sqrt(power(a.latitude_center - b.latitude, 2) + power(a.longitude_center - b.longitude, 2)) as distance
...
select grid_cell_id, initials as nearest_airport, distance
from distance_to_airports a
