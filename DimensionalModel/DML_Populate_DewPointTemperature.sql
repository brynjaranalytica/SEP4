...
declare
  ...
  dew_point_temperature_celsius_max number(6, 0) := 100;
...
begin
  while (dew_point_temperature_celsius <= dew_point_temperature_celsius_max) loop   
    ...
    insert into D_DewPointTemperature
      values (DEFAULT, dew_point_temperature_fahrenheit, dew_point_temperature_celsius, dew_point_temperature_kelvin);
